...
export const DevIcon = ({  }) => {
  ...
  const gradientBlue ='#090E96'
  const skyDay = '#0070f0'
  const skyNight = '#052659'
  const detailTable = '#fff'
  const pink = '#ff6ec7'
  const yellow = '#e6cc00'
  const purple = '#8a00c2'
...
{/* Perna Esquerda */}
<path fill-rule="evenodd" clip-rule="evenodd" d="M320.92 468.56C321.42 482.77 326.24 589.34 326.24 589.34C329.61 593.23 351.89 585.24 353.45 579.83C353.45 579.83 363.01 461.2 359.28 460.65C355.61 460.16 320.92 468.56 320.92 468.56Z" fill="url(#paint6_linear_272_98)"/>
{/* Sapato Direito */}
<path  className="animation-100 dark:fill-dark-shoe fill-light-shoe"  fill-rule="evenodd" clip-rule="evenodd" d="M454.5 567.65C454.5 567.65 464.99 580.32 478.5 586.04C492.07 591.71 498.18 594.09 495.99 597.62C493.8 601.1 476.41 599.41 463.34 599.86C450.22 600.31 441.38 601.3 440.93 597.18C440.48 593.01 442.57 570.1 442.57 570.1L454.5 567.65Z" fill="currentColor"/>
{/* Perna Direita */}
<path fill-rule="evenodd" clip-rule="evenodd" d="M248.62 425.67C247.03 436.75 230.18 454.1 250.71 471.44C271.23 488.78 403.37 474.12 405.06 476.46C406.75 478.75 439.45 591.18 439.45 591.18C439.45 591.18 467.74 590.29 466.26 578.71C455.34 548.55 457.14 452.26 435.03 441.72C412.95 431.19 248.62 425.67 248.62 425.67Z" fill="url(#paint7_linear_272_98)"/>
{/* Camiseta */}
<path fill-rule="evenodd" clip-rule="evenodd" d="M302.78 269.49C283.85 264.47 227.27 260.42 219.69 276.6C202.09 314.17 216.1 458.53 240.6 460.91C256.35 462.45 334.53 460.06 337.16 431.69C340.6 394.37 306.06 340.4 302.78 269.49Z" fill="url(#paint8_linear_272_98)"/>
<path className="dark:fill-dark-detail fill-light-detail" fill-rule="evenodd" clip-rule="evenodd" d="M218.18 387.29H237.36V482.5H218.18V387.29Z" fill="currentColor"/>
<path className="dark:fill-dark-detail fill-light-detail" fill-rule="evenodd" clip-rule="evenodd" d="M214.1 386.52H233.28V481.73H214.1V386.52Z" fill="currentColor"/>
<path  fill-rule="evenodd" clip-rule="evenodd" d="M302.78 269.49C291.75 273.96 294.33 295.28 299.35 310.54C304.37 325.75 355.9 361.77 371.16 365.75C386.42 369.68 447.44 361.98 447.44 361.98C451.42 353.78 447.99 345.08 440.63 346.97C440.63 346.97 381.1 345.23 372.45 335.24C365.55 327.23 314.41 264.77 302.78 269.49Z" fill="url(#paint9_linear_272_98)"/>
...
{/* Borda da Cadeira */}
<path className="dark:fill-dark-detail fill-light-detail" fill-rule="evenodd" clip-rule="evenodd" d="M200.88 309.7H273.87C279.15 309.7 283.51 315.56 283.51 322.72V377.18C283.51 384.34 279.15 390.2 273.87 390.2H200.88C195.56 390.2 191.21 384.34 191.21 377.18V322.72C191.21 315.56 195.56 309.7 200.88 309.7Z" fill="currentColor"/>
{/* Parte de Trás da Cadeira e Pistão */}
<path className="dark:fill-dark-detail fill-light-detail" fill-rule="evenodd" clip-rule="evenodd" d="M193.71 309.86H266.7C271.98 309.86 276.34 315.72 276.34 322.88V377.34C276.34 384.5 271.98 390.36 266.7 390.36H193.71C188.39 390.36 184.04 384.5 184.04 377.34V322.88C184.03 315.72 188.39 309.86 193.71 309.86ZM283.53 486.65H300.72V583.7H283.53V486.65Z" fill="red"/>
{/* Suporte Rodinhas */}
<path className="dark:fill-dark-detail fill-light-detail" fill-rule="evenodd" clip-rule="evenodd" d="M230.8 581.61H355.68V588.42H230.8V581.61Z" fill="currentColor"/>
{/* Assento da Cadeira e Rodinhas */}
<path className="dark:fill-dark-detail fill-light-detail" fill-rule="evenodd" clip-rule="evenodd" d="M353.05 599.25C358.12 599.25 362.19 595.17 362.19 590.16C362.19 585.09 358.12 581.02 353.05 581.02C348.03 581.02 343.96 585.09 343.96 590.16C343.95 595.18 348.03 599.25 353.05 599.25ZM291.02 599.05C296.09 599.05 300.16 594.97 300.16 589.96C300.16 584.89 296.08 580.82 291.02 580.82C286 580.82 281.93 584.89 281.93 589.96C281.92 594.97 286 599.05 291.02 599.05ZM231.2 599.25C236.22 599.25 240.34 595.17 240.34 590.16C240.34 585.09 236.22 581.02 231.2 581.02C226.18 581.02 222.06 585.09 222.06 590.16C222.06 595.18 226.18 599.25 231.2 599.25ZM211.5 471.44H372.7C378.81 471.44 383.78 476.41 383.78 482.47C383.78 488.58 378.81 493.55 372.7 493.55H211.5C205.44 493.55 200.47 488.58 200.47 482.47C200.47 476.41 205.44 471.44 211.5 471.44Z" fill="currentColor"/>
{/* Gola */}
...
<stop className="animation" stopColor={theme === 'dark' ? `${skyNight}` : `${skyDay}`}/>
<stop className="animation" offset="1"  stopColor={theme === 'dark' ?  '#000' : "#fff"}/>
</linearGradient>
<linearGradient id="paint1_linear_272_98" x1="641.158" y1="489.084" x2="644.282" y2="489.084" gradientUnits="userSpaceOnUse">
<stop className="animation" offset="1" stopColor={theme === 'dark' ? `${skyNight}` : `${skyDay}`}/>
<stop offset="1" stopColor={gradientBlue}/>
</linearGradient>
...
<stop offset="0.23" stopColor="#3113C2"/>
<stop offset="0.348" stopColor="#2F18C5"/>
{/* Cotovelo Esquerdo */}
<stop offset="0.493" stopColor="#2927ff"/>
<stop offset="0.652" stopColor="#1F40D8"/>
{/* Antebraço Esquerdo */}
<stop offset="0.822" stopColor="#126"/>
<stop offset="0.998" stopColor="#008FFF"/>
...
<linearGradient id="paint6_linear_272_98" x1="340.829" y1="474.88" x2="345.481" y2="581.868" gradientUnits="userSpaceOnUse">
  ...
  <stop offset="0.041" stopColor="#100022"/>
<stop offset="1" stopColor={gradientBlue}/>
</linearGradient>
<linearGradient id="paint7_linear_272_98" x1="334.145" y1="446.239" x2="458.197" y2="587.658" gradientUnits="userSpaceOnUse">
    {/* Perna Direita Gradient */}
<stop offset="0.041" stopColor="#100022"/>
<stop offset="1" stopColor={gradientBlue}/>
</linearGradient>
<linearGradient id="paint8_linear_272_98" x1="211.814" y1="363.16" x2="337.41" y2="363.16" gradientUnits="userSpaceOnUse">
...
<linearGradient id="paint9_linear_272_98" x1="299.975" y1="304.053" x2="445.298" y2="355.219" gradientUnits="userSpaceOnUse">
<stop stopColor="#7633FF"/>
<stop offset="0.097" stopColor="#7137FF"/>
<stop offset="0.216" stopColor="#6243FF"/>
<stop offset="0.346" stopColor="#4957FF"/>
<stop offset="0.484" stopColor="#2672FF"/>
<stop offset="0.61" stopColor="#0090FF"/>
</linearGradient>
<linearGradient id="paint10_linear_272_98" x1="112.784" y1="214.635" x2="627.311" y2="314.649" gradientUnits="userSpaceOnUse">
<stop offset="0.004" stopColor="#7633FF" stopOpacity="0"/>
<stop offset="0.092" stopColor="#7051FF" stopOpacity="0.0882"/>
<stop offset="0.263" stopColor="#6685FF" stopOpacity="0.2596"/>
<stop offset="0.43" stopColor="#5EB1FF" stopOpacity="0.4279"/>
<stop offset="0.591" stopColor="#57D3FF" stopOpacity="0.5893"/>
<stop offset="0.743" stopColor="#53EBFF" stopOpacity="0.7421"/>
<stop offset="0.883" stopColor="#50FAFF" stopOpacity="0.8829"/>
<stop offset="1" stopColor="#4FFFFF"/>
</linearGradient>
<linearGradient id="paint11_linear_272_98" x1="393.064" y1="120.397" x2="519.623" y2="120.397" gradientUnits="userSpaceOnUse">
<stop stopColor="#A1BAFF"/>
<stop offset="0.089" stopColor="#ACC2FF"/>
<stop offset="0.499" stopColor="#D9E3FF"/>
<stop offset="0.816" stopColor="#F5F7FF"/>
<stop offset="1" stopColor="white"/>
</linearGradient>
<clipPath id="clip0_272_98">
