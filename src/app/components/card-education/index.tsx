...
export default function CardEducation(){
 ...
 2022 - 2025
        ...
        <span className="flex items-center font-semibold text-cerenity-blue gap-1  dark:bg-dark-background  bg-light-background-transparent shadow-3xl rounded-2xl p-2">  
